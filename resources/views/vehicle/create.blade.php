@extends('layouts.app', ['activePage' => 'vehicle', 'titlePage' => __('Add New Vehicle')])
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group">
                      <input class="form-control" name="harga" id="harga" type="number" placeholder="harga" required="true" aria-required="true"/>
                      @if ($errors->has('harga'))
